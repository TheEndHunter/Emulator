...
namespace Emulator._6502.CPU.Instructions
{
    ...
    public sealed class STY_ZeroPage : STY
    {
        ...
        {
            bus.Write(bus.ReadWord(ZeroPage(ref registers, bus)), registers.Y);
            return 4;
        }
    }
    public sealed class STY_Absolute : STY
    {
        ...
        public override byte Execute(ref Registers6502 registers, Bus6502 bus)
        {
            bus.Write(bus.ReadWord(Absolute(ref registers, bus)), registers.Y);
            return 3;
        }
    }
    ...
    public sealed class STY_ZeroPageX : STY
    {
        ...
        public override byte Execute(ref Registers6502 registers, Bus6502 bus)
        {
            bus.Write(bus.ReadWord(ZeroPageX(ref registers, bus)), registers.Y);
            return 4;
        }
    }
}
