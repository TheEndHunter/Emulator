...
{
    public sealed class SystemBusLE<BusWidth> : SystemBus<BusWidth> where BusWidth : unmanaged, IComparable<BusWidth>, IEquatable<BusWidth>, IComparer<BusWidth>, IEqualityComparer<BusWidth>, IFormattable
    {
        public SystemBusLE() : base(ByteOrder.Little)
        {
            
        }

        public override byte ReadByte(BusWidth address)
        {
